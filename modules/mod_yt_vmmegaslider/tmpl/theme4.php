...
<div id="yt_megasslider_<?php echo $module->id;?>" class="yt_megasslider" style="width: <?php echo $width_module_mega;?>px; height: <?php echo $thumb_height?>">
    <?php ob_start();?>
    	<div class="yt-contentmegaslider-nav" style="width: <?php echo $width_module_mega?>px; height:<?php echo $thumb_height+35?>px;">
            ...
            <div class="class-button-<?php echo $theme.'-'.$module->id;?> <?php if($position_image_display == "left"){echo 'class-button-image-position-right-'.$theme;}else{echo 'class-button-image-position-left-'.$theme;}?>" style="width:<?php echo $thumb_width+40?>px;top:<?php echo ($thumb_height/2)- 10;?>px;display:<?php echo $showButton;?>;z-index: 9999;">
            	<div style="float:left; position:relative; z-index:9999; top:8px;">
            		<div class="button-prev<?php echo $module->id;?> mega-buttons-preview-<?php echo $theme;?>">&nbsp;&nbsp;&nbsp;</div>
            	</div>
            	<div style="position:relative; z-index:9999; float:right; top:8px;">
            		<div class="button-next<?php echo $module->id;?> mega-buttons-next-<?php echo $theme;?>">&nbsp;&nbsp;&nbsp;</div>
            	</div>
            </div>
            <?php endif;?>
            <div id="yt_megasslider_nav<?php echo $module->id;?>" style="width:<?php echo $width_module_mega;?>px !important;height:<?php echo $thumb_height?>px !important;">
                <?php foreach($items as $key=>$item) {?>
    				<div class="megaslider-content-article" style="width:<?php echo $width_module_mega;?>px">
                        <?php ob_start();?>
                        <div class="<?php if($position_image_display == "left"){echo 'megaslider-main-image-'.$theme;}else{echo 'megaslider-main-image-right-'.$theme;}?>" style="width:<?php echo $thumb_width?>px; height:<?php echo $thumb_height;?>px; ">
                        ...
                        <?php ob_start();?>
                        <?php if($showmaincontenttheme4 == 1):?>
                        <div class="<?php if($position_image_display == "left"){echo 'content-mega-main-'.$theme;}else{echo 'content-mega-main-right-'.$theme;}?>" style="width:<?php echo $width_module_mega - ($thumb_width + 45);?>px;height:<?php echo $thumb_height;?>px;">
                            <div class="hidden-main-content-<?php echo $theme;?>">
                                ...
                                <?php endif;?>
                                <?php if($showmaindesc == 'yes'):?><div class="item_content_main_theme1"><p style="color:<?php echo $maindesccolor;?>;"><?php echo $item['sub_main_content']?></p></div><?php endif;?>
                            </div>
                            ...
                            <a href="<?php echo $item['link'];?>" class="<?php if($target=='pop-up'):?>modal<?php endif;?>" title="<?php echo $item['title'];?>" target = "<?php echo $target;?>" >
                                <div class="<?php if($position_image_display == "left"){echo 'icon_readmore_right_'.$theme;}else{echo 'icon_readmore_'.$theme;}?>">
                                    <div title="<?php echo $item['title'];?>" class="read_text_mega"><?php echo $readmore_mega_text;?></div>
                            ...
                            <a href="<?php echo $item['link'];?>" class="<?php if($target=='pop-up'):?>modal<?php endif;?>" title="<?php echo $item['title'];?>" target = "<?php echo $target;?>" >
                                <div title="<?php echo $item['title'];?>" class="<?php if($position_image_display == "left"){echo 'icon_readmore_right_'.$stylereadmore;}else{echo 'icon_readmore_'.$stylereadmore;}?>">
                            ...
                            <a href="<?php echo $item['link'];?>" class="<?php if($target=='pop-up'):?>modal<?php endif;?>" title="<?php echo $item['title'];?>" target = "<?php echo $target;?>" >
                                <div class="<?php if($position_image_display == "left"){echo 'icon_readmore_right_'.$stylereadmore;}else{echo 'icon_readmore_'.$stylereadmore;}?>">
    ...
    <div class="ytc-content ytc_background_<?php echo $theme;?>" style="width: <?php echo $width_module_mega-1;?>px; position:relative; overflow:hidden">
        <?php
