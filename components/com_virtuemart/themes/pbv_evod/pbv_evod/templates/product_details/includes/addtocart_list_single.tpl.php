        ...
        <div class="vmCartChildElement<?php echo $cls_suffix ?>">
            ...
            if( $_SESSION['auth']['show_prices'] && _SHOW_PRICES) { 
                ...
                if( $product['price'] != $product['actual_price'] ) { ?>
                    <span class="product-Old-Price" style="vertical-align:top;"><?php echo $product['price'] ?>&nbsp;</span>
                <?php 
				}
				?> 
                <span class="productPrice" style="vertical-align:top;"><?php echo $product['actual_price'] ?></span>
            <?php } ?>
			</span>
        </div>
