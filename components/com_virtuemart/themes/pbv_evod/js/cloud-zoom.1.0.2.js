...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            $mouseTrap = jWin.parent().append(format("<div class='mousetrap' style='background-image:url(\".\");z-index:8;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;\'></div>", sImg.outerWidth(), sImg.outerHeight(), 0, 0)).find(':last');
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:7;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
                ...
                lens = jWin.append(format("<div class = 'cloud-zoom-lens' style='display:none;z-index:6;position:absolute;width:%0px;height:%1px;'></div>", cw, ch)).find(':last');
        ...
        this.each(function () {
            ...
            if (jQuery(this).is('.cloud-zoom')) {
                ...
                if (jQuery(this).parent().attr('id') != 'wrap') {
                    jQuery(this).wrap('<div id="wrap" style="top:0px;z-index:9;position:relative;"></div>');
                }
