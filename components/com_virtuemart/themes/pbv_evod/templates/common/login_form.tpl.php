...
<form action="<?php echo $action ?>" method="post" name="login" style="margin-left:20px;">
	<label for="username_login"><?php echo $VM_LANG->_('USERNAME') ?></label><br style="clear:both" />
	<input type="text" id="username_login" name="username" class="inputbox" size="20" />
	<br />
	<br />
	<label for="passwd_login"><?php echo $VM_LANG->_('PASSWORD') ?></label><br style="clear:both" /> 
	<input type="password" id="passwd_login" name="passwd" class="inputbox" size="20" /><br style="clear:both" />
	(<a title="<?php echo $VM_LANG->_('LOST_PASSWORD'); ?>" style="font-size:12px;" href="<?php echo $lostPwUrl; ?>"><?php echo $VM_LANG->_('LOST_PASSWORD'); ?></a>)
	<br />
	<br />
