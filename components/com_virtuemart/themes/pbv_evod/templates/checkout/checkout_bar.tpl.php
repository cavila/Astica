...
$highlighted_style = 'class="vmCheckoutHighlight"';
$i = 1;
...
<table class="vmCheckout" style="float:left;margin:5px 0 15px;width:99%;text-align:center;color: #FFFFFF;valign:center;background: #000;" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>';

foreach ($steps_to_do as $step ) {
	
	echo '<td '.(($highlighted_step==$step[0]['step_order']) ? $highlighted_style : '') .' style="padding:8px 5px;" width="119" align="center" valign="bottom">';
	if ($highlighted_step > $step[0]['step_order'] ) {
