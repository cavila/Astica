...
define( 'URL', 'http://localhost/Astica/' );
define( 'SECUREURL', 'http://localhost/Astica/' );

if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/pbv_evod/' );
} else {
define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/pbv_evod/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/pbv_evod/' );
...
define('DOWNLOADROOT', 'C:\Users\USUARIO\Desktop\GL\Astica/media/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '46a062f67351ca4b7fcf37fcd53a1640');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
