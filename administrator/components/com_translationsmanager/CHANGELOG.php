...
^ Change name from fftranslation to translationsmanager
...
^ Move CSS to translationsmanager.css and change layout/template files accordingly
^ Move JS to translationsmanager.js and change layout/template files accordingly
